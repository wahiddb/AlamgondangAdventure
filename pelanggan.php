            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="card shadow">
                        ...
                        <div class="card-body"><a class="card-link" href="add_pelanggan.php"><button class="btn btn-primary btn-info"><i class="fa fa-plus"></i>&nbsp;Tambah Data Pelanggan</button></a>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group" role="group">
                                                        <a href='edit_pelanggan.php?id=<?php echo $row['no_ktp']; ?>'>
                                                            <button class="btn btn-primary btn-success" type="button">
                                                                <i class="fa fa-edit"></i>Edit</button>
                                                        </a>
                                                        <a href='delete_pelanggan.php?id=<?php echo $row['no_ktp']; ?>' onclick="return confirm('Anda yakin mau menghapus data pelanggan ini ?')">
