                ...
                <div class="container-fluid">
                    <div class="card shadow">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 font-weight-bold">Daftar Alat</p>
                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group" role="group">
                                                        <a href='edit_alat.php?id=<?php echo $row['id_alat']; ?>'>
                                                            <button class="btn btn-primary btn-success" type="button">
                                                                <i class="fa fa-edit"></i>Edit</button>
                                                        </a>
                                                        <a href='delete_alat.php?id=<?php echo $row['id_alat']; ?>' onclick="return confirm('Anda yakin mau menghapus data alat ini ?')">
