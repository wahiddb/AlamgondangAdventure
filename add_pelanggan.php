                ...
                <div class="container-fluid">
                    <div class="col">
                        <div class="card shadow">
                            <div class="card-body">
                                <form method="post" action="aksi_add_pelanggan.php">
                                    <div class="form-group">
                                        <label for="address">
                                            <strong>No KTP</strong>
                                            <br>
                                        </label>
                                        <input class="form-control" type="text" name="no_ktp" onkeypress="return event.charCode >= 48 && event.charCode <=57" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="address">
                                            <strong>Nama</strong>
                                        ...
                                        <input class="form-control" type="text" name="nama" onkeypress="return event.charCode < 48 || event.charCode  >57" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="address">
