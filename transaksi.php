            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="card shadow">
                        ...
                        <div class="card-body"><a class="card-link" href="add_transaksi.php"><button class="btn btn-primary btn-info"><i class="fa fa-plus"></i>&nbsp;Tambah Transaksi</button></a>
                            <div class="table-responsive table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info">
                                <table class="table dataTable my-0" id="dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        if (isset($_GET['cari'])) {
                                            $cari = $_GET['cari'];
                                            $query = "SELECT * FROM view_transaksi where nama like '%" . $cari . "%'";
                                            $result = mysqli_query($connect, $query) or die(mysqli_error($connect));
                                        } else {
                                            $query = "SELECT * FROM view_transaksi ORDER BY id_order ASC";
                                            $result = mysqli_query($connect, $query) or die(mysqli_error($connect));
                                        }
                                        while ($row = mysqli_fetch_array($result)) {
                                            ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group" role="group">
                                                        <a href='edit_transaksi.php?id=<?php echo $row['id_order']; ?>'>
                                                            <button class="btn btn-primary btn-success" type="button">
                                                                <i class="fa fa-edit"></i>Edit</button>
                                                        </a>
                                                        <a href='delete_transaksi.php?id=<?php echo $row['id_order']; ?>' onclick="return confirm('Konfirmasi jika sudah kembali ?')">
                                                            <button class="btn btn-primary btn-warning" type="button">
                                                                <i class="fa fa-check"></i>Kembali</button>
                                                        </a>
                                                    </div>
                                                </td>
                                            </tr>
